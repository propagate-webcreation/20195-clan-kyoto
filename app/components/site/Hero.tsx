...
export function Hero() {
  return (
    ...
    >
      ...
      {/* meta corner — SP only (PC header occupies this zone) */}
      <div className="absolute top-28 left-5 sm:left-8 z-20 text-[10px] sm:text-[11px] tracking-[0.24em] uppercase text-white/70 leading-relaxed lg:hidden">
        <p>N 35.0116° / E 135.7681°</p>
        <p className="mt-1">Walk-in Tattoo Studio · Kyoto, Japan</p>
      </div>

      <div className="absolute top-[164px] sm:top-28 right-5 sm:right-8 z-20 text-[10px] sm:text-[11px] tracking-[0.24em] uppercase text-white/70 text-right leading-relaxed lg:hidden">
        <p>Est. 2025</p>
        <p className="mt-1">Three booths · Daily 11:00–21:00</p>
      </div>

      {/* main headline — header safe zone + bottom anchor */}
      <div className="relative z-10 min-h-[100svh] max-w-[1600px] mx-auto px-5 sm:px-8 grid grid-rows-[auto_minmax(0,1fr)_auto]">
        <div className="h-28 sm:h-32 lg:h-36 shrink-0" aria-hidden="true" />

        <div className="min-h-0" aria-hidden="true" />

        <div className="pb-36 sm:pb-48 min-w-0 max-h-[calc(100svh-8rem)] lg:max-h-[calc(100svh-10rem)]">
          <div className="grid grid-cols-12 gap-y-6">
            <div className="col-span-12 lg:col-span-9 min-w-0">
              ...
              <h1 className="display text-white text-[clamp(3.4rem,11vw,11.5rem)] lg:text-[clamp(2.5rem,min(6vw,9.5svh),4.25rem)] xl:text-[clamp(2.75rem,min(6.5vw,10.5svh),4.75rem)] leading-[0.84] tracking-[-0.02em]">
                <motion.span
            ...
            <div className="col-span-12 lg:col-span-3 lg:pl-0 lg:-ml-6 flex flex-col justify-end gap-6 items-start min-w-0">
              <motion.p
          ...
          <motion.div
            ...
            className="mt-8 sm:mt-12 flex items-end justify-between gap-4 text-[10px] sm:text-[11px] tracking-[0.24em] uppercase text-white/50 min-w-0"
          >
            <div className="flex items-center gap-3 min-w-0">
              <span className="block w-8 sm:w-12 h-px bg-white/40 shrink-0" />
              <span>Scroll</span>
            </div>
